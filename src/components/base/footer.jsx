...
function Footer() {
  return (
    <div className="w-full background-footer flex justify-center">
      <div className="w-11/12 md:w-10/12 w-full flex flex-col items-center text-white py-12 px-4 md:px-0">
        <div className="w-full mb-12">
          <p className="text-2xl md:text-3xl font-bold">
            Heavenly Cow
          </p>
          <p className="text-lg md:text-xl mt-1">Luxurious Steakhouse</p>
        </div>
        <div className="w-full flex justify-between flex-wrap">
          <div className="w-80 text-l md:text-xl mb-12">
            <p>1234 Dragon Avenue,</p>
            <p className="mt-1"> Dragonspiral Tower, Floor 23</p>
          </div>
          <div className="w-80 text-l md:text-xl mb-12">
